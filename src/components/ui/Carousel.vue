<template>
  <div class="q-pa-md">
    <q-carousel
      ...
      arrows
      height="300px"
      class="bg-white-9 shadow-2 rounded-borders"
    >
      <q-carousel-slide :name="1" class="column no-wrap">
        <div class="row fit justify-start items-center q-gutter-xs q-col-gutter no-wrap">
          <Categories class="rounded-borders col-6 full-height"></Categories>
          <Banner class="rounded-borders col-6 full-height"></Banner>
        </div>
      </q-carousel-slide>
